...
(function () {
        ...
        if (!document.getElementById('mode-switch-container')) {
            ...
            if (viewMode === 'input') {
                ...
                if (pager) {
                    ...
                    pager.style.minHeight = '48px';
                    pager.style.height = 'auto';
                    pager.style.boxSizing = 'border-box';
                    pager.style.overflow = 'visible';
                ...
                // ★ 編集モード用フィルターの作成 (ページャー最左端へ配置)
                createEditModeFilters(filterTarget);
    ...
    function setupInfobarNavButtons() {
        ...
        if (!navContainer) {
            ...
            btnOverview.title = '予約待ち受け制御画面を表示します';
    ...
    async function createEditModeFilters(parentElement) {
        ...
        if (parentElement) {
            if (parentElement.classList && parentElement.classList.contains('gaia-argoui-app-index-pager')) {
        ...
        btnFilter.style.padding = '0 12px';
        btnFilter.style.height = '28px';
