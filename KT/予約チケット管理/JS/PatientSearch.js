...
(function () {
    ...
    function showStatusLegendDialog() {
        ...
        const legendData = [
            ...
            { status: '電話不通', desc: '依頼者へお電話を差し上げたがお繋ぎできず、折り返しのご連絡をお願い・待機している状態' },
            { status: '電話合意済', desc: '電話にて患者と直接対話し、日時について決定・合意した状態' },
            ...
            { status: '評価待ち', desc: '患者の受診予定日時が経過し、受診確認（人物メモ等の入力）とチケット終了の操作を待機している状態' },
